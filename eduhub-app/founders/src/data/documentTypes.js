// Copied verbatim from the client app (frontend/src/data/documentTypes.js)
// — kept as a second copy rather than a shared package so the two apps stay
// fully independent (see project notes on why). If a document type ever
...
export const CHILD_DOCUMENT_TYPES = [
  ...
  // the client app's main checklist — they render inline next to "Sports
  // achievements" and the SEN question instead. Still listed here so this
  // app's Document Vault can label them correctly if a family has uploaded
  // one.
